...
class Queries {
  ...
  public function q_1() {
    ...
    $query = "SELECT id, descrizione, versioneDMS, CodDealerCM, CodAziendaSId, VAT FROM Azienda a WHERE a.id_CasaMadre = 1 AND a.isDealer = 1 AND a.attiva = 1 AND a.CodMercato = 'IT';";
