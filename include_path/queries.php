...
class Queries {
  ...
  public function q_1() {
    ...
    $query = "SELECT id, descrizione as Dealer, versioneDMS as Versione, CodDealerCM as 'Cod.Ford', CodAziendaSId as sID, VAT FROM Azienda a WHERE a.id_CasaMadre = 1 AND a.isDealer = 1 AND a.attiva = 1 AND a.CodMercato = 'IT';";
